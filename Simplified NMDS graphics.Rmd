...
from Stations @, 4, 5 and 8 to Stations 1,2,3,and 4.  We'll have to make the 
same changes in other data too.
...
## Header Data
```{r make_header_data}
header_data <- data.frame(station = zoopw$STATION,
                          date = zoopw$DATE,
...
I will want to use the names of these variables as labels in graphics later.
